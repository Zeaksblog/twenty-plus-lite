...
?>
	...
	<header class="entry-header">
		...
		<?php
			...
			if ($theme_options['post_switch'] =='0'){ ?>
		...
		<?php
			$theme_options = get_option('tto_theme_options');
			if ($theme_options['post_switch'] =='1'){ ?>
				...
				<?php the_post_thumbnail('post-excerpt-thumbnail', 'class=alignleft'); ?></a>
				</div><!-- .post-excerpt-thumb -->
				<div class="entry-summary">
					<?php echo get_the_post_excerpt(); ?>
				</div><!-- .entry-summary -->
		<?php
			}
		?>
